...
gdjs.WinnerScreenCode.asyncCallback10752108 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.WinnerScreenCode.asyncCallback10752108(runtimeScene, asyncObjectsList)));
}
}
