...
gdjs.WinnerScreenCode.userFunc0xc1af58 = function GDJSInlineCode(runtimeScene) {
"use strict";
  ...
  if (isMobile) {
    window.location.href = 'https://t.me/mts_officetour_school_bot';
  } else {
    window.open('https://t.me/mts_officetour_school_bot', '_blank');
  }
};
...
gdjs.WinnerScreenCode.userFunc0xc1af58(runtimeScene);
